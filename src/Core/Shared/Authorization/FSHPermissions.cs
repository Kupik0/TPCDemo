...
namespace TPCDemo.Shared.Authorization;
...
public static class FSHResource
{
    ...
    public const string Kedis = nameof(Kedis);
    public const string Hayvans = nameof(Hayvans);
}
...
public static class FSHPermissions
{
    private static readonly FSHPermission[] _all = new FSHPermission[]
    {
        ...
        new("View Kedis", FSHAction.View, FSHResource.Kedis, IsBasic: true),
        new("Search Kedis", FSHAction.Search, FSHResource.Kedis, IsBasic: true),
        new("Create Kedis", FSHAction.Create, FSHResource.Kedis),
        new("Update Kedis", FSHAction.Update, FSHResource.Kedis),
        new("Delete Kedis", FSHAction.Delete, FSHResource.Kedis),
        new("Generate Kedis", FSHAction.Generate, FSHResource.Kedis),
        new("Clean Kedis", FSHAction.Clean, FSHResource.Kedis),
        new("View Hayvans", FSHAction.View, FSHResource.Hayvans, IsBasic: true),
        new("Search Hayvans", FSHAction.Search, FSHResource.Hayvans, IsBasic: true),
        new("Create Hayvans", FSHAction.Create, FSHResource.Hayvans),
        new("Update Hayvans", FSHAction.Update, FSHResource.Hayvans),
        new("Delete Hayvans", FSHAction.Delete, FSHResource.Hayvans),
        new("Generate Hayvans", FSHAction.Generate, FSHResource.Hayvans),
        new("Clean Hayvans", FSHAction.Clean, FSHResource.Hayvans),
